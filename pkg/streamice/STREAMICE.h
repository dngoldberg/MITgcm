...
C     -------------------------- CHAR PARAMS ---------------------------------------------------
      ...
      CHARACTER*(MAX_LEN_FNAM) STREAMICEdummyAtimedepFile
      CHARACTER*(MAX_LEN_FNAM) STREAMICEdummyBtimedepFile
...
!     CHARACTER PARAMS FOR TRACER
     ...
     &     STREAMICEdummyAtimedepFile,
     &     STREAMICEdummyBtimedepFile,
...
C     &     A_glen,
     ...
     &     H_streamice_prev,
     &     u_new_si, v_new_si,
     &     dummyA_streamice, dummyB_streamice
...
!! POSITIVE WHERE MELTING
      ...
      _RL dummyA_streamice (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL dummyB_streamice (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
     ...
     &   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL bdot_streamice1
     &   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL dummyA_streamice0
     &   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL dummyA_streamice1
     &   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL dummyB_streamice0
     &   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL dummyB_streamice1
     &   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
#endif
